...
PoliwrathEvosAttacks:
	dbbw EVOLVE_ITEM, HEART_STONE, POLIWORTH ; PLACEHOLDER
	db 0 ; no more evolutions
	dbw 1, WATER_GUN
	dbw 1, HYPNOSIS
	dbw 1, DOUBLESLAP
