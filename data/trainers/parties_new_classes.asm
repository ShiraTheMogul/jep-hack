...
WalkerGroup:
	...
	db 60
	dw SKARMORY
	dw NO_ITEM ; Fire-type damage reduction item here please!
...
XXXGroup: ; South Man
	...
	db 60
	dw WEEZING ; WEEZINGG
	dw NO_ITEM ; Ground-type reducing item
...
AgathaGroup:
	...
	db 60
	dw GENGAR
	dw MAGNET ; psychic damage-reducing item?
...
GreenGroup:
	...
	db 60
	dw GYARADOS
	dw NO_ITEM ; electric damage-reducing item
