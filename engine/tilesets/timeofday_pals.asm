...
; DUSK_F, NITE_F, DAY_F, MORN_F
	dc DUSK_F,     NITE_F,     DAY_F,      MORN_F     ; PALETTE_AUTO
	...
	dc DUSK_F,     DUSK_F,     DUSK_F,     DUSK_F     ; PALETTE_DUSK
;	dc DUSK_F,     NITE_F,     DAY_F,      MORN_F
;	dc DUSK_F,     NITE_F,     DAY_F,      MORN_F
;	dc DUSK_F,     NITE_F,     DAY_F,      MORN_F
