...
DEF DUSK     EQU 1 << DUSK_F

DEF ANYTIME EQU MORN | DAY | NITE | DUSK

; wTimeOfDayPalset::
; Must be different from any in ReplaceTimeOfDayPals.BrightnessLevels
DARKNESS_PALSET EQU (MORN_F << 6) | (DAY_F << 4) | (DUSK_F << 2) | NITE_F
...
; seems later versions of pokecrystal define some sram stuff here too? I'm under the assumption that's a non issue though.
; wItemFlags::
	const_def
	const IN_BAG_F
	const IN_PC_F