...
PapyoFrames:    INCLUDE "gfx/pokemon/papyo/frames.asm"
...
AtlansteusFrames:    INCLUDE "gfx/pokemon/atlansteus/frames.asm"
...
CorsolaGFrames:    INCLUDE "gfx/pokemon/corsolag/frames.asm"
